...
**Tools & Frameworks**: LangChain, Ultralytics (YOLO), NumPy, Pandas, Ollama, Dify
...
**Technologies**: Java, C, SQL (PostgreSQL), HTML/CSS, Express.js, OpenShift, Apache Maven, Git
...
**Tools**: SPSS, RStudio, Google Colab, JupyterHub, Statistical Modeling
